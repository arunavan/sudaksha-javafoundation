class StringDemo 
{
		public static void main(String[] args) 
		{
			...
			//	String sc5 = new String(sc4);
				...
				System.out.println("Equals : "+sc4.equals(sc5));
				System.out.println("== Operator : "+(sc4 == sc5));
			...
			// "Syntax : boolean regionMatches(boolean ignoreCase, int startIndex, String str2, int str2StartIndex, int numChars)" );
				...
				System.out.println("Length : "+s11.length());
